...
```
PR Review Progress:
- [ ] Step 0: Detect GitHub host (github.com vs REDACTED)
...
- **Use `$GH_HOST_ENV` for GitHub Enterprise instances (REDACTED)**
...
- Problem: Using `POST /repos/{owner}/{repo}/pulls/comments/{comment_id}/replies` returns 404 on both github.com and REDACTED
...
- History: Failed on github.com (03-09, PR 3360) and REDACTED (03-03, PR 369)
